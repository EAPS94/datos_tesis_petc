...
from src.etl.columnas_2016 import columnas_estandar
from utils.logging_config import configurar_logger

# Inicializa el logger
logger = configurar_logger("consolidador_2016", archivo_log="consolidador_archivos.log")
...
output_path = Path("output/consolidado_2016.csv")
