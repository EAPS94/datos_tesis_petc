...
logger = configurar_logger_planea("consolidador_planea_2017", archivo_log="consolidador_planea.log")

# Inicializa acumulador
anio = 2017
base_dir = Path("data/raw/planea/2017")
df_total = pd.DataFrame()

logger.info("🚀 Iniciando consolidación de archivos 2017...")
...
output_path = Path("./output/planea/consolidado_2017.csv")
df_total.to_csv(output_path, index=False, encoding="utf-8-sig")

logger.info(f"\n📁 Consolidado 2017 generado: {output_path} — Total registros: {len(df_total)}")